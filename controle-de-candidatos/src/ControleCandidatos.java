...
public class ControleCandidatos {
    ...
    public static void main(String[] args) {
        String [] candidatos =  String[] candidatos = {"FELIPE", "MARCIA", "JULIA", "PAULO", "AUGUSTO"};
    ...
    static void selecaoCandidatos() {
        String[] candidatos = {"FELIPE", "MARCIA", "JULIA", "PAULO", "AUGUSTO", "MONICA", "FABRICIO", "MIRELA", "DANIELA", "ANA", "CARLA", "JOAO"};
